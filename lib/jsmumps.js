...
function JSMumps(opts)
{
    ...
    process.on('SIGINT', (code) => {
        console.log("jsmumps:  user initiated parent process shutdown (SIGINT) with code", code);
...
JSMumps.prototype.shutdown = function (exitCode) {
    ...
    console.error("jsmumps:  sending CP_SHUTDOWN to " + this.workers.length + " worker processes");
    ...
    setTimeout(() => {
        ...
        console.log("jsmumps:  sending SIGTERM to all remaining worker processes");
