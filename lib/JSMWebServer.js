...
function Server(options)
{
	...
	if(that.Cluster.isMaster) {
	    console.log("JSMumps - Asynchronous Application and Web Server for GT.M");
	    console.log(" Version 0.0.1");
	    console.log("");
	    console.log("Copyright (C) 2016 Coherent Logic Development LLC")
	    console.log("");
		...
		that.children[child].on('message', function(message) {
		    console.log(message);
		});
	    }
