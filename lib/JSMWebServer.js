...
function Server(options)
{
	...
	var application = new Application.JSMApplication(session, request, response, that.parsedURL);
	...
	if(that.Cluster.isMaster) {
	    ...
	    that.socketServer = new require('./JSMSocketServer').JSMSocketServer(that);
