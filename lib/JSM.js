...
function JSM(socket, db) {
    ...
    this.next = function(global, subscripts, callback) {
    ...
    this.nextSync = function(global, subscripts) {
    ...
    this.previous = function(global, subscripts, callback) {
    ...
    this.previousSync = function(global, subscripts) {
